...
{    # 異体字セレクタもどき + 〝〟 (U+301F, U+301F)
    my $test_str = pack( 'C*',
        0x26, 0x23, 0x31, 0x32, 0x37, 0x39, 0x38,
        0x38, 0x3b, 0x87, 0x80, 0x87, 0x81 );
    my $binary = pack( 'C*',
        0x26, 0x23, 0x31, 0x32, 0x37, 0x39, 0x38, 0x38, 0x3b,
        0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc,
        0xfc, 0xfc, 0xfc, 0x87, 0x80, 0x87, 0x81 );
    my $res = ZPL_delfc::replace_cmd $binary;
    is( $res, $test_str, "Check: Broken Emoji + Double Prime Quotation Mark" );
